...
<?php include 'header.php' ?>
    <div class="container">
        ...
        <div class="profi">
            <div class="profil">
            <img src="data:image/jpeg;base64,<?= base64_encode($rowProfile['PHOTO']) ?>" alt="Profile Photo">
            ...
            <div class="des">
                <div class="description">
                    ...
                    <div class="lien">
                        <button><a href="#">En savoir plus sur moi</a></button>
                        <button><a href="#">M'envoyer un message</a></button>
